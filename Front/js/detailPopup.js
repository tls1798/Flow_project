...
const createPopup = function(ntNo, typeNo, rmNo){
...
const clearAndUpdatePopup = function(ntNo, typeNo, rmNo) {
    // 초기화
    $('#detailComment').children().remove();
    ...
    // detailPopup 업데이트
    createPopup(ntNo, typeNo, rmNo);
}

export default function updatePopup(ntNo, typeNo, rmNo) {
    // detailPopup 초기화 및 업데이트
    return clearAndUpdatePopup(ntNo, typeNo, rmNo);
}