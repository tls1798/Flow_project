...
public class PostsService {
    ...
    //  특정 프로젝트 방 전체 글 가져오기
    public List<Posts> getPosts(int memNo, String rmNo) {
        return postsMapper.selectAll(memNo, rmNo);
    }

    //  특정 프로젝트 방 특정 글 하나 가져오기
    public Posts getPost(int memNo, String rmNo, int postNo) {
        return postsMapper.selectOne(memNo, rmNo, postNo);
    }
